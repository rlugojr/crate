...
/**
 * Helper functions to migrate between {@link InputList} based and {@link Row} based components.
 */
public class RowBridging {

    public static InputList toInputs(final Supplier<Row> rowSupplier, int numCols){
        ...
        return InputList.wrap(result);
    }

    public static Object[] materialize(InputList inputs){
    ...
    public static Row toRow(InputList inputs){
        assert inputs != null: "inputs must not be null";
        return new Row() {
            @Override
